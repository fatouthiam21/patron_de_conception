...
class DictionaryCracker implements PasswordCrackingAlgorithm {
    ...
    DictionaryCracker(String chemin, String password, boolean estUnHash) {
            this.password = estUnHash ? getPasswordFromHash(password) : password;
             this.chemin = chemin;
             this.mot_de_passe_trouve = false;
             this.hash = estUnHash ? password : getPasswordFromHash(password);
    }
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(chemin))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length == 2) {
                    ...
                    if (password.equals(mot_de_passe) || hash.equals(hash_mot_de_passe)) {
